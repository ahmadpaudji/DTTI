<html>
	...
	<body>
		...
		<div class="row" style="margin-top :50px;margin-bottom:25px;">
			<p class=""style="font-size:24px;">Rekapitulasi Punishment Pegawai</p>
		</div>		
		...
		<div class="row">
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $i++; ?></td>
						<td><?php echo $pun['nma_lkp_pgw'];?></td>
						<td><?php echo $pun['SP1'];?></td>
						<td><?php echo $pun['SP2'];?></td>
						<td><?php echo $pun['SP3'];?></td>
					</tr>
					<?php
						}
					?>
