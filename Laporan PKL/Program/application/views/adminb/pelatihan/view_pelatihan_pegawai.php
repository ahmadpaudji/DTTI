				...
				<div class="page-header">
					<div class="pull-left">
						...
						<?php
							...
							{
						?>
						<a href="<?php echo base_url(); ?>admin/pelatihan/tambah" class="btn btn-primary">Tambah</a>
						<?php
							}
						?>
					</div>
				...
				<div class="row-fluid">
					...
					?>
						...
						<div class="box">
							...
							<form action="<?php echo base_url()."admin/pelatihan/cari" ; ?>" method="POST" class='form-horizontal form-validate'>
									...
									<tbody>
										...
										<tr>
											...
											<td class="btn-group">
												...
												?>
													<li>
														<a href="<?php echo base_url(); ?>admin/pelatihan/ubah/<?php echo $peng->id_lth; ?>">Ubah</a>
													</li>
												<?php
												}
