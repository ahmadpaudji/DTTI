			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-edit"></i>Rekapitulasi SPPD</h3>
							</div>
							...
							<form class='form-horizontal form-validate'>
								...
								<div class="control-group">
									...
									<div class="controls">
										<?php
											$tgl_awal = explode('-', $sppd->tanggal_awal);
								...
								<div class="control-group">
									...
									<div class="controls">
										<?php
											$tgl_akhir = explode('-', $sppd->tanggal_akhir);
				...
				<div class="row-fluid">
					<div class="span12">
						...
						?>
							<div>
								<a href="<?php echo base_url("admin/sppd/cetakRekap");?>" style="margin-left:2px" class="btn btn-primary">CETAK</a>
