			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					?>
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-edit"></i>Tambah Reward</h3>
							</div>
							<div class="box-content">
								<form action="<?php echo base_url() ; ?>admin/reward/aksi_tambah" method="POST" class='form-horizontal form-validate' id="bb">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="keterangan" id="keterangan" placeholder="Contoh : Naik haji" class="input-xlarge" data-rule-required="true" data-rule-minlength="4" data-rule-maxlength="40">
										</div>
									</div>
