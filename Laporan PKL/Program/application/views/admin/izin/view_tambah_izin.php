			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					?>
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-edit"></i>Tambah Izin Presensi</h3>
							</div>
							<div class="box-content">
								<form action="<?php echo base_url() ; ?>admin/izin/aksi_tambah" method="POST" enctype="multipart/form-data" class='form-horizontal form-validate' id="bb">
									
									<div class="control-group">
										<label for="textfield" class="control-label">Tanggal Awal</label>
										<div class="controls">
											<input type="text" name="tanggal_mulai" id="tanggal_mulai" class="input-medium datepick" data-rule-required="true">
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea type="text" name="alasan" id="alasan" placeholder="Contoh : Sakit batuk dan tidak bisa datang hari ini" class="input-xlarge" data-rule-required="true" data-rule-minlength="5" data-rule-maxlength="99"></textarea>
										</div>
									</div>
									<div class="control-group">
