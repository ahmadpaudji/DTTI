			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3><i class="icon-edit"></i>Rekapitulasi Izin Presensi</h3>
							</div>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						?>
							<div>
								<a href="<?php echo base_url("admin/izin/cetak");?>" style="margin-left:2px" class="btn btn-primary">CETAK</a>
