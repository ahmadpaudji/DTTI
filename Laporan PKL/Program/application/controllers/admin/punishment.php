...
class Punishment extends Admin_Controller
{
	...
	{
		$data['punishment'] = $this->model_punishment->cetak();
		$data['direktur'] = $this->model_punishment->get_direktur();
		
		$html = $this->load->view('pdf/cetak_rekappunishment',$data,true);
		// Get output html
		// Load library
		...
		$this->dompdf->render();
		$this->dompdf->stream("Rekap_Reward.pdf");
