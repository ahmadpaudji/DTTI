...
insert  into `tb_pelatihan`(`id_lth`,`tgl_pjn_lth`,`nma_pju_lth`,`nma_lth`,`waktu_lth`,`tmp_lth`,`stat_lth`,`apprv_lth`,`jbt_apprv_lth`) values (1,'2014-09-22','Handoyo','Cobaa','2014-09-23','dadf','Y','Handoyo','komisaris(komisaris)'),(2,'2014-09-22','Handoyo','Coba Lagi','2014-09-24','Bandung','T','Handoyo','komisaris(komisaris)'),(3,'2014-09-22','Handoyo','asdeee','2014-09-15','fadw','N',NULL,NULL);
